...
typedef enum OMColorType {
    ...
    OMColorTypeToUIColor,           //[@"#eeeeee" toUIColor]
	
} OMColorType;

static BOOL OMColorTypeIsNSColor(OMColorType colorType) { return colorType >= OMColorTypeNSRGBACalibrated; }
...
@interface OMColorHelper : NSObject {
    ...
    NSRegularExpression *_toUIColorRegex;
}
